"""Module de test / expérimentation reprenant un contrôleur de test caméra et pipeline."""
...
class TestController:
    ...
    def snapshot(self):
        ...
        metadata = {
            ...
            "source": source_name,
            "status": "snapshot",
            "frame_number": self.last_context.frame_number if hasattr(self, "last_context") else None,
            "fps": self.last_context.statistics.fps if hasattr(self, "last_context") else None,
            "processing_time_ms": self.last_context.statistics.processing_time_ms if hasattr(self, "last_context") else None,            
        }
